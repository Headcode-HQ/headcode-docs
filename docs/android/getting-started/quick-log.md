...
If you have enabled **Publish locomotives online** in [Settings](/android/settings/community-database), Headcode can also send the locomotive record to the online community database when you create a new spot.
